...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const getMenuItems = () => {
    ...
    const roleBasedItems: Record<UserRole, typeof commonItems> = {
      head_teacher: [
        ...commonItems,
        {
          label: "Students",
    ...
    return roleBasedItems[user?.role || "student"];
  };
              ...
              <nav className="space-y-2">
                {getMenuItems().map((item, index) => (
                  <Link
                    key={index}
                    to={item.path}
                    className={`flex items-center px-4 py-3 text-blue-700 hover:bg-blue-50 border-l-4 transition-colors ${
